...
class BoletaQController extends Controller
{
    //
    ...
    /////////////////////////////
    ////Cabecera
    //$header = array("ASIGNATURA","PARCIAL 1","PARCIAL 2","%Acum EX. PARCIALES","EXAMEN ORDINARIO","%EXAMEN ORDINARIO","CALIFICACION FINAL");
    //$pdf->SetWidths(array(28,16,16,16,16,16,16,16));
    //$pdf->SetAligns(array('L','C','C','L','C','L','C'));
    $pdf->SetFont('Arial','',6);
    $pdf->setY(50);
    $pdf->setX(12);
    ...
    $pdf->Cell(24,5,' ',1,0,'C');
        ...
        $pdf->Output('I', utf8_decode(('Boleta5')));
        exit;
